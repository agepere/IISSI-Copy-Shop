<?php
	...
	$_SESSION["TIPOCATALOGO"]= "Servicio";
	...
	$query= "SELECT IDCATALOGO,NOMBRE,TIPOPRODUCTO,TIPOCATALOGO,DESCRIPCION,PRECIO,IVA,STOCK,STOCKMINIMO FROM CATALOGO WHERE (TipoCatalogo='Servicio') ";
	...
	<main>
	 <nav>
		<div id="enlaces">
			...
			<?php }	else { ?>			
						<a href="consultarCatalogoServicio.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>"><?php echo $pagina; ?></a>
			<?php } ?>			
		</div>
		
		<form id="formulario" method="get" action="consultarCatalogoServicio.php">
